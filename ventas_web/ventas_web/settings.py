"""
Django settings for ventas_web project.
...
SECRET_KEY = 'django-insecure-)_o@+#i6$w%@c#tmm!=#j0p=qzi9mnuk(n+ou@&+qf#daxji#7'
...
WSGI_APPLICATION = 'ventas_web.wsgi.application'
